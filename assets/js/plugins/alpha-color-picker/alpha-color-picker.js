...
( function( $ ) {
	...
	$.fn.alphaColorPicker = function() {
		...
		return this.each( function() {
			...
			// We must wrap the input now in order to get our a top level class around the HTML added by wpColorPicker().
			...
			colorPickerOptions = {
				change: function( event, ui ) {
					...
					// If we're in the Customizer, send an ajax request to wp.customize to trigger the Save action.
			...
			$container.find( '.iris-palette' ).on( 'click', function() {
				...
				// Sometimes Iris doesn't set a perfect background-color on the palette, for example rgba(20, 80, 100, 0.3) becomes rgba(20, 80, 100, 0.298039).
