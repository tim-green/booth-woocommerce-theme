...
$image_url = wp_get_attachment_image_url( $image_id, 'booth_woo_block_item_long' );
...
>
	<div class="block-item-content-wrap">
		<div class="block-item-content">
			...
			<?php if ( $subtitle ) : ?>
				<p class="block-item-subtitle"><?php echo wp_kses( $subtitle, booth_woo_get_allowed_tags( 'guide' ) ); ?></p>
			<?php endif; ?>

			<a href="<?php echo esc_url( $link_url ); ?>" class="btn btn-sm btn-block-item">
				<?php esc_html_e( 'Shop now', 'booth-woo' ); ?>
			</a>
		</div>
	</div>
</div>
