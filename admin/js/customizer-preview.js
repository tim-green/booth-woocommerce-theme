...
(function ($) {
	...
	wp.customize('footer_text_color', function (value) {
		value.bind(function (to) {
			$('.footer-widgets,' +
				...
				'.footer-widgets .tg-contact-widget-item i').css('color', to);
		});
	});
	...
	wp.customize('footer_border_color', function (value) {
		value.bind(function (to) {
			$('.footer-widgets .social-icon,' +
				'.footer-widgets .tg-schedule-widget-table tr,' +
	...
	wp.customize('theme_lightbox', function (value) {
		value.bind(function (to) {
			if (to) {
				$(".booth-woo-lightbox, a[data-lightbox^='gal']").magnificPopup({
					type: 'image',
				...
				$(".booth-woo-lightbox, a[data-lightbox^='gal']").off('click');
			}
		});
	});
			...
			createStyleSheet('site_border_color', [
				{
					...
					selectors: 'hr,' +
						...
						'.sidebar .social-icon,' +
						'.sidebar .tg-schedule-widget-table tr,' +
						'.sidebar .widget_meta li a,' +
						'.sidebar .widget_pages li a,' +
						'.sidebar .widget_categories li a,' +
						'.sidebar .widget_archive li a,' +
