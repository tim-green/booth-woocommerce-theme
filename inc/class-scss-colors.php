...
class Booth_Woo_SCSS_Colors {
	...
	public function __construct( $filename ) {
		if ( is_readable( $filename ) && is_file( $filename ) ) {
			...
			// does a file_get_contents() itself anyway), we use file() instead. It is no different than require()ing  or include()ing the file and saving its contents into an output buffer.
	 ...
	 * @param string      
	 * $var The name of the SCSS variable, without the dollar sign.
